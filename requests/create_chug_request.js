...
var Create_Chug_Request = function(options) {
	_.extend(this, options);
	fast_bindall(this);
};

_.extend(Create_Chug_Request.prototype, base_request.prototype, {
	fulfill: function() {
		async.series([
	...
	build_response: function(callback) {
		delete this.server.caches.chugs;
		this.response = { status: "Ok" };
		process.nextTick(callback);
	}
});

module.exports = Create_Chug_Request;
